...
export default function Tools() {
  ...
  const toolSet: any = {
    ...
    property: [
      // { id: 1, title: currentLanguage?.FN_HN , imageUrl: '/images/property.png', href: '/bug-log/citizen/find-new-holding-no' },
      ...
      { id: 2, title: "Check Property Status", imageUrl: '/images/support.png', href: '/bug-log/citizen/track-status?type=property' },
    ],
    water: [
      {
        id: 1,
      ...
      { id: 1, title:"Know Your Water status", imageUrl: '/images/support.png', href: '/bug-log/citizen/track-status?type=water' },
    ...
    trade_License: [
      ...
      { id: 2, title: "Know Your Trdae license Status", imageUrl: '/images/support.png', href: '/bug-log/citizen/track-status?type=trade_License' },
    ...
    pet_Registration: [
      ...
      { id: 3, title: currentLanguage?.SA_NO, imageUrl: '/images/support.png', href: '/bug-log/citizen/track-status?type=pet_Registration' },
    ],
    water_Tanker_Booking: [
      ...
      { id: 2, title: currentLanguage?.SA_NO, imageUrl: '/images/support.png', href: '/bug-log/citizen/track-status?type=water_Tanker_Booking' },
    ...
    solid_Waste_User_Charge: [
      ...
      { id: 2, title: currentLanguage?.SA_NO, imageUrl: '/images/support.png', href: '/bug-log/citizen/track-status?type=solid_Waste_User_Charge' },
    ...
    Rig_Machine_Registration: [
      { id: 1,
         ...
         imageUrl: '/images/rule.png',
          ...
          href: 'https://jharkhandegovernance.com/citizen/act&rules', },
          { id: 2, title: currentLanguage?.SA_NO, imageUrl: '/images/support.png', href: '/bug-log/citizen/track-status?type=Rig_Machine_Registration' },

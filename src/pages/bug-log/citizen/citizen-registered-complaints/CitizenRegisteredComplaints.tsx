              ...
              <div className="flex-1 flex justify-end">
                <div>
                  <Badge
                    ...
                    variant="secondary"
                    onClick={() =>
                      navigate(`/bug-log/citizen-dashboard/citizen-review?complaintId=${items?._id}`)
                    }
                  >
                    Give Your Feedback
                  </Badge>
                  <Badge
                    className="ml-4 cursor-pointer"
                    onClick={() =>
                      navigate(`/bug-log/citizen-dashboard/citizen-complaint-details?complaintRefNo=${items?.complaintRefNo}`)
                    }
                  >
                    View Details
                  </Badge>

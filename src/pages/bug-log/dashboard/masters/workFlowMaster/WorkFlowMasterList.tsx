            ...
            {addLevel?.map((data) => {
              return (
                <BreadcrumbItem key={data}>
                  <BreadcrumbLink
                    href={`/bug-log/dashboard/workflow-master?parentId=${parentId}&levelSerial=${levelSerial}`}
                  >
                    <div className='flex '>
                      {data}
                      ...
                      <TableRow key={items._id}>
                        ...
                        <TableCell className='space-x-2'>
                          ...
                          <Button
                            ...
                            onClick={() => {
                              navigate(
                                `/bug-log/dashboard/workflow-master?parentId=${items?._id}&levelSerial=${items?.levelSerial + 1}&parentName=${items.workFlowName}&moduleName=${items?.module?.moduleName}`
                              )
                            }}
                          >
                            View

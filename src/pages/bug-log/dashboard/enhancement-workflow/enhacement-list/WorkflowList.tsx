...
import { STATE_GRO, SUPER_ADMIN } from '@/../config/roles.config'
import {
  Tabs,
  TabsContent,
  TabsList,
  ...
  return (
    <main className='grid items-start'>
      ...
      <Tabs defaultValue="INBOX" className="w-full ">
        <div className="flex">
          {user?.roleId !== SUPER_ADMIN && <CardTitle className='flex-1 text-2xl font-bold'>Enhancement List</CardTitle>}
          {user?.roleId === SUPER_ADMIN && <CardTitle className='flex-1 text-2xl font-bold'><span className='text-amber-500'>{projectName}</span> | Enhancement List</CardTitle>}

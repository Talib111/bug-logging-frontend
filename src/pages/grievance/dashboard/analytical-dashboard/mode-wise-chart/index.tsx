...
export default function ComplaintTypeChart({ dashboardData }: any) {
  ...
  const donutchartData = [
    { browser: "chrome", complaints: 70, fill: "var(--color-chrome)" },
    { browser: "safari", complaints: 60, fill: "var(--color-safari)" },
    { browser: "firefox", complaints: 240, fill: "var(--color-firefox)" },
    { browser: "edge", complaints: 7, fill: "var(--color-edge)" },
    ...
    <Card className="flex flex-col h-[370px]">
      <CardHeader className="items-center pb-0">
        <div className="flex justify-between space-x-4 items-center">
          <div> <CardTitle>Mode Wise Grievances</CardTitle></div>
          <div><Link to={'/grievance/dashboard/complaint-reports'}><Button size={'sm'} variant={'secondary'}>Explore <ChevronRight size={15} className="inline" /></Button></Link></div>
        </div>

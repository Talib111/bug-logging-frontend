    ...
    <Card className="h-[370px]">
      <CardHeader>
       <div className="flex justify-between">
        ...
        <div><Link to={'/grievance/dashboard/resolution-days-reports'}><Button size={'sm'} variant={'secondary'}>Explore <ChevronRight size={15} className="inline" /></Button></Link></div>
       </div>

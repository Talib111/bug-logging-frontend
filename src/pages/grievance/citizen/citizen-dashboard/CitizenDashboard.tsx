...
export default function CitizenDashboard() {
  ...
  const popularOptions = [
    { id: 1, label: currentLanguage?.MG, linkUrl: '/grievance/citizen-dashboard/all-complaints', iconUrl: list },
    { id: 2, label: currentLanguage?.MP, linkUrl: '/grievance/citizen-dashboard/profile', iconUrl: profile },
  ...
  return (
    <div className="sm:p-10 p-1">
      ...
      <div className='grid md:grid-cols-3 col-span-1 gap-4 mt-6'>
        <div>
          <Link to={'/grievance/citizen-dashboard/all-complaints'}>
        ...
        <div>
          <Link to={'/grievance/citizen-dashboard/citizen-testimonials'}>
            <Card className="cursor-pointer">
              <CardHeader>
      ...
      {isOpen && (
        ...
        onClick={() => navigate("/grievance/citizen/citizen-grievance-via-email")}
      />
                </div>
              </TooltipTrigger>
        ...
        onClick={() => navigate("/grievance/citizen/citizen-grievance-via-whatsapp")}
      />
                </div>
              </TooltipTrigger>

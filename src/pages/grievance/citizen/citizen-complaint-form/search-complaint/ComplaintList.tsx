  ...
  return (
      <Dialog>
        ...
        <DialogContent className="sm:max-w-[500px] z-50">
          <CardTitle className='mt-4 text-xl text-gray-500 font-bold flex justify-between'>Complaint Registration <Link to={`/grievance/citizen/complaint-registration-info`} target='_blank'><span className='text-amber-600 underline cursor-pointer'>Know How it works?</span></Link> </CardTitle>

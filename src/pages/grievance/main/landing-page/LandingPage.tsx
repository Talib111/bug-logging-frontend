                ...
                <div className="container px-4 md:px-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div className="cursor-pointer group">
                            ...
                            //------------------------------- This Id is refer to Enquiry Types
                            > */}
                            <Link to={`/grievance/citizen/citizen-track-complaint`}>   <Card className="h-full bg-card hover:bg-card/90 transition-colors">
                                <CardHeader className="flex flex-col items-center text-center">
                                    <div className="w-12 h-12 rounded-full bg-[#99B37C] flex items-center justify-center mb-4 group-hover:bg-[#99B37C]/60 transition-colors">
                                        <PersonStanding className="h-6 w-6 text-white" />
                                    </div>
                        ...
                        <div className="cursor-pointer group">
                            ...
                            // ------------------------------ This Id is refer to Corruptions Types
                            > */}
                            <Link to={`/grievance/citizen/citizen-send-reminder`}>  <Card className="h-full bg-card hover:bg-card/90 transition-colors">
                                <CardHeader className="flex flex-col items-center text-center">
                                    <div className="w-12 h-12 rounded-full bg-[#99B37C] flex items-center justify-center mb-4 group-hover:bg-[#99B37C]/60 transition-colors">
                                        <Users className="h-6 w-6 text-white" />
                                    </div>
                        ...
                        <div className="cursor-pointer group">
                            ...
                            //------------------------------ This Id is refer to Suggestions Types
                            > */}
                            <Link to={`/grievance/citizen/citizen-review`}>  <Card className="h-full bg-card hover:bg-card/90 transition-colors">
                                <CardHeader className="flex flex-col items-center text-center">
                                    <div className="w-12 h-12 rounded-full bg-[#99B37C] flex items-center justify-center mb-4 group-hover:bg-[#99B37C]/60 transition-colors">
                                        <Leaf className="h-6 w-6 text-white" />
                                    </div>
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            {/* <div className="flex justify-center gap-8">
                                {[
                                    { icon: <PhoneCall className="w-8 h-8" />, link: '/grievance/citizen/citizen-grievance-via-phone', label: 'Phone' },
                                    { icon: '/images/whatsapp.png', link: '/grievance/citizen/citizen-grievance-via-whatsapp', label: 'WhatsApp' },
                                    { icon: '/images/gmail.png', link: '/grievance/citizen/citizen-grievance-via-email', label: 'Email' },
                            ...
                            <div className="flex justify-center gap-8">
                                {[
                                    { icon: <PhoneCall className="w-8 h-8" />, link: '/grievance/citizen/citizen-grievance-via-phone', label:   currentLanguage?.PHONE },
                                    { icon: '/images/whatsapp.png', link: '/grievance/citizen/citizen-grievance-via-whatsapp', label: currentLanguage?.WHATSAPP },
                                    { icon: '/images/gmail.png', link: '/grievance/citizen/citizen-grievance-via-email', label:currentLanguage?.EMAIL },
